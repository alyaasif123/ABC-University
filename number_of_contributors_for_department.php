<?php
$page_title = 'Number of contributors within each Department';
$page_slug = 'Number of contributors within each Department';
$page_description = 'Number of contributors within each Department';
$page_keyword = 'Number of contributors within each Department, University';
$site_name = "ABC University";
$project_name = $site_name.' | ';

include('template/header.php');

/*$result = $db_controller->getNumberOfContributorsForDepartment();
echo '<br><br><br><br>';
print_r($result);*/
$pieData[] = array('Department', 'contributors');
?>
    ...
    <div class="">
        ...
        <div class="col-md-6 box2">
            <div class="style_box most_popular">
                <h3 class="h3_style">Number of contributors within each Department
                </h3>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $key => $value) {
                                $pieData[] =  array($value['Dep_name'], $value['count']);
                            ?>
                            <tr>
                                <th scope="row"><?php echo $a; ?></th>
                                <td scope="row"><?php echo $value['Dep_name']; ?></td>
