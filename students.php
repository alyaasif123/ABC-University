...
$page_title = 'Students';
$page_slug = 'students';
$page_description = 'Students';
$page_keyword = 'Students, University';
$site_name = "ABC University";
$project_name = $site_name.' | ';

include('template/header.php');

$students = $db_controller->getStudentDetails();
    ...
    <div class="">
        ...
        <div class="col-md-6 box2">
            <div class="style_box most_popular">
                <h3 class="h3_style">List of Students
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_user.php?id=<?php echo $value['Student_Id']; ?>&type=student" class="btn label-warning action_icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fa fa-pencil"></i>
                                    </a>&nbsp;

                                    <a href="delete_user.php?id=<?php echo $value['Student_Id']; ?>&type=student" class="btn label-danger action_icon" data-toggle="tooltip" data-placement="top" title="Delete">
