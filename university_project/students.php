                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_acadamic_year.php?id=<?php echo $value['Student_Id']; ?>" class="label label-warning" data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>&nbsp;

                                    <a href="delete_acadamic_year.php?id=<?php echo $value['Student_Id']; ?>" class="label label-danger" data-toggle="tooltip" data-placement="top" title="Delete">
