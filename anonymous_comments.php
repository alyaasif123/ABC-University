<?php
$page_title = 'Anonymous Comments';
$page_slug = 'Anonymous Comments';
$page_description = 'Anonymous Comments';
$page_keyword = 'Anonymous Comments, University';
...
$res_total = $db_controller->getAnonymousCommentsCount();
...
$result = $db_controller->getAnonymousCommentsList($offset, $limit);
    ...
    <div class="">
        ...
        <div class="col-md-6 box2">
            <div class="style_box most_popular">
                <h3 class="h3_style">List of Anonymous Comments
                </h3>
